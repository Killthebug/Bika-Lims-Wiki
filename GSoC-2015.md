...
Students wishing to participate will be required to produce code for Bika OS LIMS in 3 months, but don't have to be a proven developer. However, experience in [python programming language](http://python.org) and [Plone CMS](http://plone.org) is welcome.
