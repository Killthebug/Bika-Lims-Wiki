...
* You like the basic idea of the project but it is not such a good fit for the skills that you have.
    ...
    In this case, please fell free to suggest an alternative, but try to remember that the idea is for the software to be useful for its existing and potential users.
