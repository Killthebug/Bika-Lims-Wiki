...
***
### Table of ContenYou are here: [Home](https://github.com/bikalabs/Bika-LIMS/wiki) · GSoC 2015
***
### Table of Contents
...
### ID03. Froid. Free Open Instrument Middleware 
**Description**

The Open Instrument Middleware is an idea of a free-standing instrument server for easy interface of any laboratory instrument to any laboratory software. Once established, the software should be vendor neutral to attract as many interfaces possible, all open sourced on the AGLP for protection. The current Bika LIMS interface module was designed with this in mind and can be used as a basis.
...
Froid is a working title. Propose your own! Other candidates are: Omar -Open Middleware, Opium Open Instrument Middleware 
...
### ID06. SQL back-end for Bika LIMS
...
### ID07. EduLIMS add-on for Bika LIMS
