...
It also forms the basis of upcoming Bika branch for bioinformatics and biobanking, and is also used in veterinary settings with animal subjects and veterinarians in these roles. 

Bika Health is about 60% compliant with [FDA's 21 CFR Part 11](http://en.wikipedia.org/wiki/Title_21_CFR_Part_11) standard through customisations done for the ISO 17025 and CLIA standards. Further customisation and additional features are required:
